...
<div class="content">
   ...
   $stmt = $db->prepare('INSERT INTO blogs (articleTitle,articleDescription,articleContent,articleDate,articleSlug,articleTags,image) VALUES (:articleTitle, :articleDescription, :articleContent, :articleDate, :articlSlug, :articleTags, :image)') ;
